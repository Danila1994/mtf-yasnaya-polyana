    ...
    <main className="page">
      ...
      <section className="hero">
        ...
        <div className="card">
          ...
          <MenuItem icon="📋" title="Ежедневный отчет" text="Надой, поголовье, отёлы, падёж, комментарии" />
          ...
          <div className="notice">Статус: стартовая страница работает. Следующий этап — подключение настоящей базы данных.</div>
        </div>
      </section>
    </main>
  );
